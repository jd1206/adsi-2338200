        ...
        <div class="row ">
            ...
            <?php echo "<h1 class='mt-5 border border-top-0 border-start-0 border-end-0'>Conditionals</h1>"; ?>
                <?php 
					...
					//var_dump($studends);
				?>
				<div class="btn-group-vertical " style="widht: 400px;">
				<?php foreach ($studends as $key => $value): ?>
					<button type="button" class="btn btn-warning text-start" style="border: 2px solid black;">
						<?php echo $key ?>
						<span class="badge badge-danger float-end text-dark "><?php echo $value ?></span>
					</button>
				<?php endforeach ?>
				</div>
            </div>
